...
SECRET_KEY = 'django-insecure-pcq5kaf#tbn&n8+i#^1&8t-cns#27!!3uy9o#m)p)nfhx15=js'
...
DATABASES = {
    'default': {
        ...
        'USER': 'adminblog',
        'PASSWORD': 'admin123',
        'HOST': 'localhost',#'db', # este es el nombre del servicio de la base de datos en docker-compose
        'PORT': '5432',
    }
}
...
#LOGIN_URL = '/' # URL to redirect to when login is required
#LOGIN_REDIRECT_URL = '/posts/'  # URL to redirect to after successful login
